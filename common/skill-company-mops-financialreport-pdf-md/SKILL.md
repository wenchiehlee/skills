---
name: skill-company-mops-financialreport-pdf-md
description: >-
...
- `skill-company-mops-financialreport-pdf-md`: downloads MOPS financial statement PDFs such as `AI1`, `AI2`, `AI3`, and `AE2` under `MOPS/downloads/<company_id>/`.
...
```bash
python ../skills/common/skill-company-mops-financialreport-pdf-md/scripts/run_mops_financialreport_pdf_md.py <company_id> <year> <quarter>
```

Examples:

```bash
python ../skills/common/skill-company-mops-financialreport-pdf-md/scripts/run_mops_financialreport_pdf_md.py 2382 2025 all
python ../skills/common/skill-company-mops-financialreport-pdf-md/scripts/run_mops_financialreport_pdf_md.py 2382 2026 1 --skip-download
python ../skills/common/skill-company-mops-financialreport-pdf-md/scripts/run_mops_financialreport_pdf_md.py 2330 2025 4 --only-missing-files
```
...
```bash
python ../skills/common/skill-company-mops-financialreport-pdf-md/scripts/run_mops_financialreport_pdf_md.py <company_id> <year> <quarter> --skip-download
