---
name: skill-stock-earnings-calendar-monitor
description: 財報行事曆監控：偵測資料缺漏並自動開 Issue，更新 README 看板
---

# Stock Earnings Calendar Monitor Skill
...
```bash
# 偵測並開 Issue 催更數據
python skills/skill-stock-earnings-calendar-monitor/scripts/check_calendar_gaps.py
# 刷新 README 看板
python skills/skill-stock-earnings-calendar-monitor/scripts/update_readme.py
```
