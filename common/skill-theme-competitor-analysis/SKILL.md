...
- Mark international peers such as `DELL` and `0992.HK` as `brand_competitor`; use `HPE` only for server-peer comparisons, and avoid ambiguous `HP` when the target is a PC brand and data exists.
