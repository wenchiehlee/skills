---
name: skill-company-earnings-social-verify
description: 財報公布後，從 GitHub Issue 取得貼文內容，與內部 CSV 數字逐欄比對，自動回報差異
---

# Company Earnings Social Verify Skill
...
python skills/skill-company-earnings-social-verify/scripts/compare_references.py --issue 7 --close
```
