---
name: skill-company-investorconference-ir-pdf-md
description: >-
...
```bash
python skills/skill-company-investorconference-ir-pdf-md/scripts/run_ir_pdf_to_md.py <stock_id> <year> <quarter>
```

Examples:

```bash
python skills/skill-company-investorconference-ir-pdf-md/scripts/run_ir_pdf_to_md.py 2354 2026 1
python skills/skill-company-investorconference-ir-pdf-md/scripts/run_ir_pdf_to_md.py 2330 2026 2 --skip-ingest
```
...
- PDF acquisition belongs to `skill-company-investorconference-ingest`; do not reimplement company IR/MOPS/Playwright download logic in scratch scripts.
...
```bash
python skills/skill-company-investorconference-ir-pdf-md/scripts/run_ir_pdf_to_md.py <stock_id> <year> <quarter> --skip-ingest
