...
def owner_for(flag: str) -> str:
    ...
    return "skill-company-ai-trend-analytics"
...
def write_coverage_md(root: Path, df: pd.DataFrame) -> None:
    lines = [
        ...
        f"Generated: {now_cst()}",
        "",
        "This file is generated by `skill-company-ai-trend-analytics` from canonical cycle mapping, performance, segment weights, QA, and freshness outputs.",
        "",
        "## Summary",
        "",
        f"- Rows: `{len(df)}`",
...
def write_inference_md(root: Path, coverage: pd.DataFrame, issues: pd.DataFrame) -> None:
    ...
    lines = [
        ...
        f"Generated: {now_cst()}",
        "",
        "This report is generated by `skill-company-ai-trend-analytics`. It is intentionally constrained by the coverage matrix and issue register; low-quality evidence is not promoted into high-confidence conclusions.",
        "",
        "## Quality Gate",
        "",
