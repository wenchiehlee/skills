---
name: skill-company-earnings-compare
description: 財報公布後，從 GitHub Issue 取得貼文內容，與內部 CSV 數字逐欄比對，自動回報差異
---

# Company Earnings Compare Skill
...
python skills/common/skill-company-earnings-compare/scripts/compare_references.py --issue 7 --close
```
