...
CYCLE_WEIGHTS_CSV = os.path.join(ROOT, "output", "company_cycle_major_weights.csv")
CYCLE_MAPPING_CSV = os.path.join(ROOT, "output", "company_cycle_mapping.csv")
...
def load_company_cycle_weights(stock_code):
    # 1. Try company_cycle_major_weights.csv
