...
## 9. 與 skill-company-revenue-predict 的差異比較

| 項目 | skill-company-revenue-predict | skill-company-revenue-expense-profit-predict |
|:---|:---|:---|
...
此檔案為 `skill-company-revenue-expense-profit-predict` 的標準化說明（`SKILL.md`），
請放入 `skills/common/skill-company-revenue-expense-profit-predict/` 目錄，
並確保 `biztrends.TW/skills/skill-company-revenue-expense-profit-predict/` 保持與此目錄同步。
