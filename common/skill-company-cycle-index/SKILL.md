...
```bash
python skills/skill-company-cycle-index/scripts/run_company_cycle_index.py
```
...
- 本 skill 產生 cycle model/output 層：`output/company_cycle_mapping.csv`、`output/company_cycle_major_weights.csv`、`output/company_cycle_intensity_taiwan.csv`、`output/company_cycle_intensity_by_symbol_taiwan.csv`、`output/company_cycle_index_taiwan.png` 與 README insights。
