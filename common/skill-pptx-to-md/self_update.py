...
# -*- coding: utf-8 -*-
"""
self_update.py — pptx-to-md 技能自我更新工具

以 skills 登錄庫（wenchiehlee/skills）作為唯一可信來源，
比較本地 metadata.json 與登錄庫中 common/skill-pptx-to-md 的版本，
...
注意：
- 部署後的資料夾名稱可能是 pptx-to-md（不含 skill- 前綴），
...
SKILL_SUBPATH = "common/skill-pptx-to-md"
