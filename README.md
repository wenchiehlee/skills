...
| [skill-stock-investorconference-upcoming-earnings](common/skill-stock-investorconference-upcoming-earnings) | common | financial-data | 1.0.2 | Regenerate raw_event_upcoming_earnings.csv from InvestorConference's own TW/US watchlists, classifying every event as 財報, 法說會, or 受邀法說. | 2026-08-26 |
