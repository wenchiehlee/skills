...
| [skill-mlx-api-client-ocr](common/skill-mlx-api-client-ocr) | common | document | 1.6.1 | 呼叫 Mac-mini MLX API Server 的 OCR 客戶端（Tailscale 網內），將 PDF 或圖片轉錄為 Markdown 格式，適用於健康報告、稅務文件、財報等各類文件的數位化分析。 | 2026-08-30 |
