...
| [skill-stock-MA-RSI-BBand-MACD-PEBand](common/skill-stock-MA-RSI-BBand-MACD-PEBand) | common | financial-strategy | 1.6.0 | 台股個股/ETF技術指標快照（MA/STD/布林通道、RSI、MACD）與標準 common market PE band；PEBand 用 dated EPS historical PE series，並區分 trailing EPS、forward EPS、forward consensus EPS。 | 2026-08-24 |
