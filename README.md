...
| [skill-finmind-miz](common/skill-finmind-miz) | common | document | 1.0.0 | Fetch book content from the self-hosted Calibre-Web epub reader at books.miz.com.tw via browser automation (epub.js book.spine/book.load), and export as Markdown into Miz.Fetch's books/ folder convention. | 2026-08-12 |
