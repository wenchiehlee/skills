...
| [skill-stock-dynamic-valuation-box](common/skill-stock-dynamic-valuation-box) | common | financial-strategy | 1.4.0 | Render no-look-ahead Taiwan-stock time-price diagrams (2–5 year windows) with dynamic TTM P/E valuation boxes (μ±1σ/±2σ), an optional forward-EPS/forward-PE overlay sourced from Yahoo Finance and/or FactSet consensus feeds, and optional matched buy/sell markers, using unadjusted price + statutory-deadline-gated nominal EPS. | 2026-09-21 |
