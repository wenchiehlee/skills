...
| [skill-investorconference-digest](common/skill-investorconference-digest) | common | basic | 2.4.4 | 法說會/earnings call 與財報結果 digest SOP；支援 FIN/GT/IR/Q&A、Celine 財報結果、公司財報文件、Yahoo consensus、預期差、模型修正路徑與美股對台股 read-through。 | 2026-07-23 |
| [skill-investorconference-ingest](common/skill-investorconference-ingest) | common | financial-data | 1.2.8 | 投資人說明會/財報事件材料蒐集 Ingest 模組；法說會抓音檔、IR、逐字稿，財報事件抓 Celine 財報結果、earnings release、financial tables、SEC filing，並避免對純財報事件產生 FIN/GT。 | 2026-07-23 |
