...
| [skill-stock-pipeline-health-monitor](common/skill-stock-pipeline-health-monitor) | common | financial-data | 1.1.0 | 複合技能：委派給所有 skill-*-fetch 抓取技能，維護 Data Health Dashboard 新鮮度、資料系統架構 Repo 角色對照表，並稽核跨 repo CSV 同步 YAML 與 GoodInfo/FinMind 智慧選源。 | 2026-09-23 |
