...
| [skill-all-models-benchmark](common/skill-all-models-benchmark) | common | financial-forecasting | 1.0.0 | 多模型與分析師共識效能評估標準作業程序。 | 2026-08-05 |
...
| [skill-download-logo](common/skill-download-logo) | common | basic | 1.0.0 | 指定台灣股票代碼或美股概念股 Ticker，自動下載高解析度公司官方 Logo PNG，並限制在固定大小。 | 2026-08-05 |
...
| [skill-investorconference-digest](common/skill-investorconference-digest) | common | basic | 2.4.5 | 法說會/earnings call 與財報結果 digest SOP；支援 FIN/GT/IR/Q&A、Skills 財報結果、公司財報文件、Yahoo consensus、預期差、模型修正路徑與美股對台股 read-through。 | 2026-08-05 |
...
| [skill-market-cost-distribution](common/skill-market-cost-distribution) | common | financial-forecasting | 1.0.1 | 台股市場籌碼持股成本分佈模擬（台新小時K+日K暖機雙池模型），輸出一致格式 PNG/CSV 與統一可信度、資料新鮮度標籤。 | 2026-08-05 |
...
| [skill-revenue-expense-profit-predict](common/skill-revenue-expense-profit-predict) | common | financial-forecasting | 1.0.0 | 季度損益三線（營業收入 / 總支出 / 營業利益）底部加總預測 SOP | 2026-08-05 |
| [skill-revenue-predict](common/skill-revenue-predict) | common | financial-forecasting | 1.0.0 | 營收預測與 10-Model 評估 SOP | 2026-08-05 |
