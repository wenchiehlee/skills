...
| [skill-document-diagram-design](common/skill-document-diagram-design) | common | document | 1.0.0 | 以 cathrynlavery/diagram-design 的編輯級圖表方法論，產生可嵌入 Docsify、Material for MkDocs 或 PowerPoint 的圖表；支援從既有 PlantUML/Mermaid 原始碼或圖片匯入語意後，改畫成統一風格的原生 SVG。 | 2026-09-03 |
