...
| [skill-investment-decision-coach](common/skill-investment-decision-coach) | common | financial-strategy | 1.0.4 | Provide Traditional Chinese expert-level investment decision coaching based on digested book knowledge and an investment methodology library, helping users compare investor and book-derived frameworks, build daily practical investment systems, evaluate opportunities, manage risk, avoid behavioral mistakes, and maintain coherent naming/category taxonomy for finance-related skills. | 2026-09-03 |
