...
| [skill-googlesearch-factsets-fetch](common/skill-googlesearch-factsets-fetch) | common | financial-data | 1.0.0 | 維運 GoogleSearch.Factset 兩階段管線：Stage 0 觀察名單更新、Stage 1 Search Group（API key 輪替 + 4 層內容驗證）、Stage 2 Process Group（品質評分 + 報表 + Google Sheets 上傳），並處理每日自動產生的 Quarantine Alert 資料品質議題。 | 2026-08-25 |
